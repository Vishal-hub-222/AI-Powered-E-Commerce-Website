...
const MainAppContent = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#090d16] text-slate-100 selection:bg-indigo-500 selection:text-white">
      ...
      {/* Main Container */}
      <main className="flex-1 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full">
        {/* Hero Section */}
        {!searchQuery && (
          <HeroBanner
            onOpenAiAssistant={() => setIsAiAssistantOpen(true)}
        ...
        <section id="catalog-section" className="py-6 sm:py-8 space-y-4 sm:space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 border-b border-slate-800">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-lg min-[400px]:text-xl sm:text-2xl font-extrabold font-display text-white">
                  {searchQuery
                ...
                <span className="px-2 sm:px-2.5 py-0.5 rounded-full bg-slate-800 text-indigo-300 text-[11px] sm:text-xs font-bold border border-slate-700">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs">
              ...
              <button
                ...
                className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl border transition-all flex items-center gap-1.5 font-semibold text-xs ${
                  featuredOnly
              ...
              {/* Sort Selector */}
              <div className="flex items-center gap-1.5 sm:gap-2 bg-slate-900 border border-slate-800 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl text-xs">
              ...
              <button
                ...
                className="p-2 sm:p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-400 hover:text-white transition-colors"
          ...
          {loading ? (
            ...
            <div className="py-16 sm:py-20 text-center space-y-4 glass-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-800">
              <Search className="w-10 h-10 sm:w-12 sm:h-12 text-slate-600 mx-auto" />
              <h3 className="text-base sm:text-lg font-bold text-white">No products found</h3>
            ...
            <div className="grid grid-cols-1 min-[480px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3.5 sm:gap-6">
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40">
        <button
          ...
          className="group relative flex items-center gap-2 sm:gap-3 p-3 sm:px-5 sm:py-3.5 rounded-full gradient-btn text-white font-bold shadow-2xl shadow-indigo-600/40 hover:scale-105 active:scale-95 transition-all"
          aria-label="Chat with Aura AI"
        >
          <div className="relative">
            <Bot className="w-5 h-5 sm:w-6 sm:h-6 group-hover:rotate-12 transition-transform" />
            <span className="absolute -top-1 -right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-emerald-400 rounded-full border-2 border-indigo-900 animate-ping" />
            <span className="absolute -top-1 -right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-emerald-400 rounded-full border-2 border-indigo-900" />
          </div>
